---
"description": "Leer hoe u PDF-pagina's kunt converteren naar hoogwaardige binaire TIFF-afbeeldingen met behulp van het Bradley-binarisatiealgoritme in Aspose.PDF voor .NET. Deze stapsgewijze handleiding bevat een codevoorbeeld."
"linktitle": "Bradley Binarisatie-algoritme"
"second_title": "Aspose.PDF voor .NET API-referentie"
"title": "Bradley Binarisatie-algoritme"
"url": "/nl/pdf/net/mastering-image-Processing/bradley-binarization-algorithm/"
"weight": 30
---

## Invoering

In deze tutorial begeleiden we je door het proces van het converteren van een PDF-pagina naar een TIFF-afbeelding met behulp van het Bradley Binarization Algorithm. Aspose.PDF voor .NET vereenvoudigt deze taak, waardoor je je documentworkflows eenvoudig kunt automatiseren en stroomlijnen.
...
Stel de resolutie voor de TIFF-afbeeldingen in. Een hogere DPI levert een betere beeldkwaliteit op:
...
## Stap 9: Pas het Bradley-binarisatiealgoritme toe
...
De `BinarizeBradley` Deze methode gebruikt twee bestandsstromen (invoer en uitvoer) en een drempelwaarde. Pas de drempelwaarde indien nodig aan voor optimale resultaten.
