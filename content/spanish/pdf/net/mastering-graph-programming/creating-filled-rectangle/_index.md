...
## Paso 3: Configure su directorio de documentos
...
Todo PDF necesita al menos una página. Añadamos una:
...
Elige un color para tu rectángulo. En este ejemplo, usaremos rojo.
...
## Paso 11: Guardar el documento PDF
...
¡Felicitaciones! Has creado con éxito un rectángulo relleno en un documento PDF con Aspose.PDF para .NET. Esta potente biblioteca abre un mundo de posibilidades para la manipulación de PDF, permitiéndote generar documentos impresionantes mediante programación. Ya sea que estés creando informes, facturas o cualquier otro tipo de PDF, Aspose.PDF te ayudará.
