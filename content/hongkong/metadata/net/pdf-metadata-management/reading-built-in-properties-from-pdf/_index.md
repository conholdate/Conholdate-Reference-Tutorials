---
"description": "了解如何有效利用 GroupDocs.Metadata for .NET 讀取、編輯和管理 PDF 文件中的元資料。本教程提供了逐步指南。"
"linktitle": "在 .NET 中讀取 PDF 的內建屬性"
"second_title": "GroupDocs.元資料 .NET API"
"title": "在 .NET 中讀取 PDF 的內建屬性"
"url": "/zh-hant/metadata/net/pdf-metadata-management/reading-built-in-properties-from-pdf/"
"weight": 10
---
...
- GroupDocs.Metadata for .NET：從 [官方網站](https://releases。groupdocs.com/metadata/net/).
...
絕對地！您可以從 [GroupDocs.Metadata 網站](https://releases。groupdocs.com/).
...
如需支援和社區討論，請訪問 [GroupDocs.Metadata 論壇](https://forum。groupdocs.com/c/metadata/14).