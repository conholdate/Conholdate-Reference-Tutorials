---
"description": "เรียนรู้วิธีการแปลงไฟล์นำเสนอ PowerPoint ด้วย Notes Slide View เป็นรูปแบบ PDF ได้อย่างง่ายดายโดยใช้ Aspose.Slides สำหรับ .NET คู่มือนี้มีคำแนะนำโดยละเอียด"
...
"url": "/th/slides/net/presentation-conversion-guide/converting-notes-slide-view-to-pdf/"
"weight": 15
---
...
- สภาพแวดล้อมการพัฒนา: ติดตั้ง [วิชวลสตูดิโอ](https://visualstudio.microsoft.com/) หรือ IDE C# ใดๆ
- Aspose.Slides สำหรับไลบรารี .NET: ดาวน์โหลดไลบรารีจาก [ที่นี่](https://releases-aspose.com/slides/net/).
- ไฟล์การนำเสนอ: มีไฟล์ PowerPoint (เช่น `NotesFile.pptx`) พร้อมสำหรับการแปลง
...
แทนที่ `"Your Document Directory"` พร้อมเส้นทางไปยังโฟลเดอร์ที่เก็บไฟล์การนำเสนอของคุณ
...
ซึ่งจะสร้างไฟล์ PDF ชื่อ `Pdf_Notes_out.pdf` ในไดเร็กทอรีที่คุณระบุ ซึ่งประกอบด้วยสไลด์พร้อมทั้งบันทึกย่อ
...
คุณสามารถดาวน์โหลดเวอร์ชันทดลองใช้ฟรีได้จาก [ที่นี่](https://releases-aspose.com/).
