---
"description": "เรียนรู้วิธีการแปลงช่วงหน้าเฉพาะเป็นรูปภาพ TIFF ได้อย่างง่ายดายด้วย Aspose.Words สำหรับ .NET คู่มือทีละขั้นตอนนี้จะแนะนำคุณตลอดกระบวนการ"
"linktitle": "รับช่วงหน้า TIFF ในเอกสาร Word"
"second_title": "API การประมวลผลเอกสาร Aspose.Words"
"title": "รับช่วงหน้า TIFF ในเอกสาร Word"
"url": "/th/words/net/guide-to-image-save-options/get-tiff-page-range-word-document/"
"weight": 10
---
...
1. Aspose.Words สำหรับไลบรารี .NET: ดาวน์โหลดและติดตั้งเวอร์ชันล่าสุดจาก [หน้าเผยแพร่ Aspose](https://releases-aspose.com/words/net/).
...
แน่นอน! คุณสามารถสร้างแยกได้ `ImageSaveOptions` กรณีที่มีแตกต่างกัน `PageSet` การกำหนดค่าเพื่อจัดการช่วงหน้าต่างๆ และบันทึกเป็นไฟล์ TIFF ที่แยกจากกัน
