...
자세한 방법을 알아보기 전에, 왜 이런 변환이 필요한지 간략히 알아보겠습니다.
...
콘텐츠 관리 시스템을 구축하든, 분석을 위해 문서를 처리하든, 일반 텍스트를 선호하는 레거시 시스템과 통합하든, 이 방법은 탄탄한 기반을 제공합니다. 코드는 간단한 스크립트 작성에 적합할 만큼 간단하면서도 프로덕션 애플리케이션에 적합할 만큼 강력합니다.
