...
**حل**:تأكد من عدم فتح Excel مع الملف، واستخدم التخلص المناسب من FileStream.
...
تذكر النقاط الرئيسية: تحقق دائمًا من فهرس الهدف، وتعامل مع الموارد بشكل صحيح باستخدام تدفقات الملفات، واحفظ عملك بأسماء ملفات وصفية أثناء التطوير. سواء كنت تُنشئ أنابيب معالجة البيانات أو تُؤتمت إنشاء التقارير، فإن مهارات التعامل مع أوراق العمل هذه ستفيدك كثيرًا.
...
استخدم `RemoveByName()` الطريقة بدلا من ذلك: `workbook.Worksheets.RemoveByName("SheetName")`غالبًا ما يكون هذا النهج أكثر أمانًا عندما تعرف اسم ورقة العمل المحددة، حيث لا تتأثر بتغييرات الفهرس.
