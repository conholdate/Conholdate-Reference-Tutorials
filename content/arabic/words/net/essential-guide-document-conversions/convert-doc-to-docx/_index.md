...
**حل**: عالج الملفات على دفعات أصغر أو زد مساحة ذاكرة تطبيقك. للملفات التي يزيد حجمها عن 100 ميجابايت، استخدم أساليب البث.
...
بإمكانك تحميل المستندات المحمية بكلمة مرور عن طريق تحديد كلمة المرور في LoadOptions:
```csharp
...
لا يوجد حد أقصى، ولكن قد تتطلب الملفات الكبيرة جدًا (أكثر من 500 ميجابايت) مزيدًا من الذاكرة ووقت معالجة. للحصول على أداء مثالي، يُنصح بمعالجة الملفات الكبيرة جدًا على دفعات أصغر أو ترقية موارد نظامك.
