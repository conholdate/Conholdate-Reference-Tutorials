---
"description": "تعلّم كيفية رسم أقواس مخصصة في الصور باستخدام Aspose.Imaging لـ .NET. اتبع التعليمات خطوة بخطوة لإعداد صورتك، وتهيئة سياق الرسومات، وتحديد معلمات القوس، وحفظ الناتج النهائي."
...
"url": "/ar/imaging/net/guide-to-basic-drawing/create-custom-arc-in-images/"
"weight": 10
---
...
أولاً، عليك استيراد مساحات الأسماء اللازمة للوصول إلى الوظائف التي يوفرها Aspose.Imaging. أضف ما يلي: `using` العبارات الموجودة في أعلى ملف C# الخاص بك:
