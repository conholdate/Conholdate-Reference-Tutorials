---
"description": "Découvrez comment convertir des pages PDF en images TIFF binaires de haute qualité grâce à l'algorithme de binarisation Bradley dans Aspose.PDF pour .NET. Ce guide étape par étape inclut un exemple de code."
"linktitle": "Algorithme de binarisation de Bradley"
"second_title": "Référence de l'API Aspose.PDF pour .NET"
"title": "Algorithme de binarisation de Bradley"
"url": "/fr/pdf/net/mastering-image-Processing/bradley-binarization-algorithm/"
"weight": 30
---

## Introduction

Dans ce tutoriel, nous vous guiderons dans la conversion d'une page PDF en image TIFF à l'aide de l'algorithme de binarisation Bradley. Aspose.PDF pour .NET simplifie cette tâche et vous permet d'automatiser et de rationaliser facilement vos flux de travail documentaires.
...
Définissez la résolution des images TIFF. Une résolution plus élevée améliorera la qualité d'image.
...
Le `BinarizeBradley` La méthode utilise deux flux de fichiers (entrée et sortie) et une valeur seuil. Ajustez ce seuil selon vos besoins pour des résultats optimaux.
...
Félicitations ! Vous avez converti avec succès une page PDF en image TIFF et appliqué l'algorithme de binarisation Bradley avec Aspose.PDF pour .NET. Ce processus est essentiel pour l'archivage de documents, l'OCR et d'autres applications professionnelles. Grâce à une résolution de haute qualité et une compression efficace, vos images seront nettes et leur taille sera gérable.
