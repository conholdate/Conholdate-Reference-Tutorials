---
"description": "Découvrez comment créer de belles listes numérotées dans vos documents PDF avec Aspose.PDF pour .NET. Ce guide vous guide dans l'application de différents styles de numérotation, comme les chiffres romains."
...
Cette configuration donne à votre document une taille de lettre standard avec des marges d'un pouce sur tous les côtés.
...
## Étape 3 : Création d'une boîte flottante
...
Ensuite, nous ajouterons un deuxième titre, à partir du chiffre romain 13.
...
Félicitations ! Vous avez appliqué avec succès différents styles de numérotation (chiffres romains et alphabétiques) aux titres d'un fichier PDF avec Aspose.PDF pour .NET. La flexibilité d'Aspose.PDF vous permet de contrôler la mise en page, les styles de numérotation et le positionnement du contenu, vous permettant ainsi de créer des documents PDF bien organisés et professionnels.
...
Absolument ! Vous pouvez personnaliser les styles de titres en modifiant des propriétés comme la police, la taille, le gras et l'italique à l'aide de l'icône `TextState` objet.
