---
"description": "了解如何使用强大的 Aspose.Page for .NET 库将 XPS（XML 纸张规范）文档无缝转换为 PDF（便携式文档格式）。"
"linktitle": "将 XPS 转换为 PDF"
"second_title": "Aspose.Page .NET API"
"title": "使用 Aspose.Page for .NET 将 XPS 转换为 PDF"
"url": "/zh/page/net/convert-document/converting-xps-to-pdf/"
"weight": 11
---

## 介绍

在本教程中，我们将探索如何使用功能强大的 Aspose.Page for .NET 库将 XPS（XML 纸张规范）文档转换为 PDF（可移植文档格式）。这个功能强大的库简化了文档转换，并提供各种自定义选项，是开发人员的绝佳选择。

## 先决条件

在开始之前，请确保您已准备好以下事项：

- Aspose.Page for .NET 库：从下载并安装 Aspose.Page for .NET 库 [Aspose.Page 文档](https://reference。aspose.com/page/net/).
...
PdfSaveOptions options = new PdfSaveOptions()
{
    ...
    TextCompression = PdfTextCompression.Flate, // 对文本应用 Flate 压缩
...
恭喜！您已成功使用 Aspose.Page for .NET 将 XPS 文档转换为 PDF。该库不仅简化了文档转换，还提供了处理各种格式的丰富功能。

## 常见问题解答

### 我可以将多个 XPS 文件转换为一个 PDF 吗？

当然！您可以遍历多个 XPS 文件，并按照相同的转换步骤将它们合并为一个 PDF 文档。

### Aspose.Page for .NET 支持哪些其他输出格式？

除了 PDF，Aspose.Page for .NET 还支持多种格式，包括 TIFF、JPEG 和 PNG。
