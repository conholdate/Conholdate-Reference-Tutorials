---
"description": "Khám phá cách chuyển đổi liền mạch các tài liệu XPS (XML Paper Specification) sang PDF (Portable Document Format) bằng thư viện Aspose.Page mạnh mẽ cho .NET."
"linktitle": "Chuyển đổi XPS sang PDF"
"second_title": "API Aspose.Page .NET"
"title": "Chuyển đổi XPS sang PDF bằng Aspose.Page cho .NET"
"url": "/vi/page/net/convert-document/converting-xps-to-pdf/"
"weight": 11
---
...
Bạn có thể điều chỉnh các thông số trong `PdfSaveOptions` đối tượng, chẳng hạn như chất lượng JPEG và cài đặt nén, để đạt được hình ảnh mong muốn.
