---
"description": "Khám phá cách chuyển đổi liền mạch các tệp CorelDRAW (CDR) sang định dạng PNG trong các ứng dụng .NET của bạn với Aspose.Imaging. Hướng dẫn toàn diện này cung cấp hướng dẫn từng bước."
...
"url": "/vi/imaging/net/image-conversion/convert-cdr-files-to-png/"
"weight": 11
---
...
1. Aspose.Imaging cho .NET: Tải xuống và cài đặt Aspose.Imaging cho .NET từ [trang web](https://releases.aspose.com/imaging/net/). Bạn có thể chọn giữa bản dùng thử miễn phí hoặc phiên bản trả phí tùy theo nhu cầu của mình.
