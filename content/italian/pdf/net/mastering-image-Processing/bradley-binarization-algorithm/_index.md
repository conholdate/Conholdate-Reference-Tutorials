---
"description": "Scopri come convertire pagine PDF in immagini TIFF binarie di alta qualità utilizzando l'algoritmo di binarizzazione Bradley in Aspose.PDF per .NET. Questa guida dettagliata include un esempio di codice."
"linktitle": "Algoritmo di binarizzazione di Bradley"
"second_title": "Riferimento API Aspose.PDF per .NET"
"title": "Algoritmo di binarizzazione di Bradley"
"url": "/it/pdf/net/mastering-image-Processing/bradley-binarization-algorithm/"
"weight": 30
---
...
Questa directory memorizzerà sia il PDF sorgente sia i file TIFF convertiti.
...
IL `BinarizeBradley` Il metodo accetta due flussi di file (input e output) e un valore di soglia. Regolare la soglia secondo necessità per risultati ottimali.
...
Sì, puoi modificare il `Process` metodo per scorrere tutte le pagine del documento per la conversione.

### Qual è la risoluzione ottimale per convertire i PDF in TIFF?
Per immagini di alta qualità, in genere si consiglia una risoluzione di 300 DPI, ma è possibile regolarla in base alle proprie esigenze specifiche.
