---
"description": "Pelajari cara menambahkan sentuhan profesional pada PDF Anda dengan membuat persegi panjang transparan menggunakan Aspose.PDF untuk .NET. Tutorial komprehensif ini memandu Anda dalam menginisialisasi dokumen PDF."
...
"url": "/id/pdf/net/mastering-Graph-programming/create-transparent-rectangle-with-alpha-color/"
"weight": 60
---
...
Itu `Graph` kelas memungkinkan Anda menggambar bentuk pada PDF. Buat `Graph` contoh yang menentukan lebar dan tingginya.
...
Sekarang, integrasikan bentuk yang telah Anda gambar dengan menambahkan `Graph` keberatan terhadap kumpulan paragraf halaman.
