---
"description": "Aspose.Slides for .NET का उपयोग करके चार्ट से वर्कबुक डेटा रिकवर करना सीखकर अपने पावरपॉइंट प्रेजेंटेशन की क्षमता को उजागर करें। यह चरण-दर-चरण ट्यूटोरियल आपको इस प्रक्रिया में मार्गदर्शन करता है, जिससे चार्ट डेटा को निकालना और प्रभावी ढंग से उपयोग करना आसान हो जाता है।"
...
"url": "/hi/slides/net/master-additional-chart-features/extract-workbook-data-from-charts/"
"weight": 12
---
...
हाँ! Aspose, .NET के लिए Aspose.Slides का एक निःशुल्क परीक्षण संस्करण प्रदान करता है। आप खरीदारी करने से पहले इसकी क्षमताओं का मूल्यांकन कर सकते हैं। [निःशुल्क परीक्षण यहाँ प्राप्त करें](https://releases.aspose.com/).

### मैं .NET के लिए Aspose.Slides का दस्तावेज़ कहां पा सकता हूं?

आप .NET के लिए Aspose.Slides के व्यापक दस्तावेज़ों तक पहुँच सकते हैं [यहाँ](https://reference.aspose.com/slides/net/), जिसमें उदाहरण और API संदर्भ शामिल हैं।
