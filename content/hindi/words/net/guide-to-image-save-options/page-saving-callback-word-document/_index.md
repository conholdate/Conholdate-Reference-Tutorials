---
"description": "Aspose.Words for .NET का उपयोग करके Word दस्तावेज़ के प्रत्येक पृष्ठ को आसानी से अलग-अलग PNG छवियों में परिवर्तित करना सीखें। यह मार्गदर्शिका चरण-दर-चरण निर्देश प्रदान करती है, जिसमें कोड उदाहरण भी शामिल हैं।"
"linktitle": "वर्ड दस्तावेज़ों में पृष्ठ सहेजने का कॉलबैक"
"second_title": "Aspose.Words दस्तावेज़ प्रसंस्करण API"
"title": "वर्ड दस्तावेज़ों में पृष्ठ सहेजने का कॉलबैक"
"url": "/hi/words/net/guide-to-image-save-options/page-saving-callback-word-document/"
"weight": 10
---
...
1. Aspose.Words for .NET: इसे यहां से डाउनलोड और इंस्टॉल करें [यहाँ](https://releases.aspose.com/words/net/).
...
हाँ! आप JPEG, BMP और TIFF जैसे फ़ॉर्मैट में पेज सेव कर सकते हैं। `SaveFormat` में `ImageSaveOptions`.
...
व्यापक मार्गदर्शिकाओं और उदाहरणों के लिए, देखें [Aspose.Words दस्तावेज़ीकरण](https://reference.aspose.com/words/net/).