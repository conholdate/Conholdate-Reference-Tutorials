...
अब हम रूपांतरण प्रक्रिया के सार में प्रवेश कर रहे हैं। `EpubLoadOptions` क्लास एक कॉन्फ़िगरेशन फ़ाइल की तरह है जो लोडिंग प्रक्रिया के दौरान Aspose.PDF को बताता है कि आपकी EPUB फ़ाइल को कैसे संभालना है।
...
यदि आप एकाधिक फ़ाइलें परिवर्तित कर रहे हैं, तो नई फ़ाइल न बनाएँ `EpubLoadOptions` प्रत्येक रूपांतरण के लिए एक ऑब्जेक्ट बनाएँ। मेमोरी बचाने और प्रदर्शन सुधारने के लिए इसका पुनः उपयोग करें।
