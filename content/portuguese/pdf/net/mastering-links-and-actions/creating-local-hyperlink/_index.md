---
"description": "Descubra como melhorar a navegação em seus documentos PDF criando hiperlinks locais usando o Aspose.PDF para .NET. Este tutorial passo a passo guia você por todo o processo."
"linktitle": "Criando hiperlink local em arquivo PDF"
"second_title": "Referência da API Aspose.PDF para .NET"
"title": "Criando hiperlink local em arquivo PDF"
"url": "/pt/pdf/net/mastering-links-and-actions/creating-local-hyperlink/"
"weight": 40
---
...
Clique com o botão direito do mouse em "Dependências" na pasta do seu projeto no Solution Explorer. Selecione "Gerenciar Pacotes NuGet", procure por `Aspose.PDF`e instale a versão mais recente disponível. Isso trará todas as ferramentas necessárias para criar e manipular PDFs.
...
Com certeza! Você pode acessar o teste gratuito em [Site Aspose](https://releases.aspose.com/).
