---
"description": "Erfahren Sie, wie Sie PDF-Seiten mit dem Bradley-Binarisierungsalgorithmus in Aspose.PDF für .NET in hochwertige binäre TIFF-Bilder konvertieren. Diese Schritt-für-Schritt-Anleitung enthält ein Codebeispiel."
"linktitle": "Bradley-Binarisierungsalgorithmus"
"second_title": "Aspose.PDF für .NET API-Referenz"
"title": "Bradley-Binarisierungsalgorithmus"
"url": "/de/pdf/net/mastering-image-Processing/bradley-binarization-algorithm/"
"weight": 30
---

## Einführung

In diesem Tutorial führen wir Sie durch die Konvertierung einer PDF-Seite in ein TIFF-Bild mithilfe des Bradley-Binarisierungsalgorithmus. Aspose.PDF für .NET vereinfacht diese Aufgabe und ermöglicht Ihnen die einfache Automatisierung und Optimierung Ihrer Dokumenten-Workflows.
...
Ersetzen `PageToTIFF.pdf` mit dem Namen Ihrer PDF-Datei.
...
Legen Sie die Auflösung für die TIFF-Bilder fest. Ein höherer DPI-Wert führt zu einer besseren Bildqualität:
...
## Schritt 9: Wenden Sie den Bradley-Binarisierungsalgorithmus an
...
Herzlichen Glückwunsch! Sie haben eine PDF-Seite erfolgreich in ein TIFF-Bild konvertiert und den Bradley-Binarisierungsalgorithmus mit Aspose.PDF für .NET angewendet. Dieser Prozess ist unerlässlich für die Dokumentenarchivierung, OCR und andere professionelle Anwendungen. Dank der hochwertigen Auflösung und effizienten Komprimierung sind Ihre Dokumentbilder klar und handlich.

## Häufig gestellte Fragen

### Was ist der Bradley-Algorithmus?
Der Bradley-Algorithmus ist eine Binärisierungstechnik, die Graustufenbilder in Binärbilder umwandelt, indem für jedes Pixel basierend auf seiner Umgebung ein adaptiver Schwellenwert bestimmt wird.

### Kann ich mit dieser Methode mehrere PDF-Seiten in TIFF konvertieren?
Ja, Sie können die `Process` Methode, um alle Seiten im Dokument zur Konvertierung zu durchlaufen.
...
1bpp (1 Bit pro Pixel) gibt an, dass das Bild schwarzweiß ist, wobei jedes Pixel entweder vollständig schwarz oder vollständig weiß ist.
