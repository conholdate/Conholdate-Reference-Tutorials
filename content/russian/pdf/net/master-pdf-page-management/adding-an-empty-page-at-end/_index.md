---
"description": "Узнайте, как легко добавить пустую страницу в PDF-документы с помощью библиотеки Aspose.PDF для .NET. Это пошаговое руководство проведет вас через весь процесс — от настройки среды разработки до внесения необходимых изменений в код."
"linktitle": "Добавление пустой страницы в конец"
"second_title": "Справочник по API Aspose.PDF для .NET"
"title": "Добавление пустой страницы в конец"
"url": "/ru/pdf/net/master-pdf-page-management/adding-an-empty-page-at-end/"
"weight": 130
---
...
Создайте экземпляр `Document` класс, чтобы открыть ваш PDF-файл:
...
Это сохраняет измененный файл в том же каталоге, добавляя `_out` к имени файла.
...
Aspose.PDF предлагает бесплатную пробную версию, но для длительного использования требуется лицензия. Ознакомьтесь с ценами. [здесь](https://purchase.aspose.com/buy).
