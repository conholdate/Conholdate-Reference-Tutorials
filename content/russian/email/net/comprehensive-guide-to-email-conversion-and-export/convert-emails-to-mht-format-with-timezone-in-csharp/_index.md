...
**Рекомендации по именованию файлов**: Рассмотрите возможность включения в название файла метки времени и темы. Например: `Email_2025-01-02_Meeting-Notes.mht`. Это значительно упростит поиск архивных писем в будущем.
