...
Начните с определения пути к каталогу ваших документов. Именно здесь вы будете сохранять и извлекать свои документы.
...
Настройте параметры процесса подписания. Это включает в себя указание идентификатора строки подписи и (необязательно) изображения для отображения вместе с подписью.
