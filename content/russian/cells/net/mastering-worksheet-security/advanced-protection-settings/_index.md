...
Укажите путь к файлу Excel. Это путь, по которому ваш код будет считывать данные и сохранять их:
...
Откройте нужный лист, который вы хотите защитить. В данном случае мы будем использовать первый лист:
