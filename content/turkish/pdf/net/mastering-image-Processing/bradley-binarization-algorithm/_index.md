---
"description": "Aspose.PDF for .NET'te Bradley ikilileştirme algoritmasını kullanarak PDF sayfalarını yüksek kaliteli ikili TIFF görüntülerine nasıl dönüştüreceğinizi öğrenin. Bu adım adım kılavuz, kod örnekleri içermektedir."
"linktitle": "Bradley İkilileştirme Algoritması"
"second_title": ".NET API Referansı için Aspose.PDF"
"title": "Bradley İkilileştirme Algoritması"
"url": "/tr/pdf/net/mastering-image-Processing/bradley-binarization-algorithm/"
"weight": 30
---

## giriiş

Bu eğitimde, Bradley İkilileştirme Algoritması'nı kullanarak bir PDF sayfasını TIFF görüntüsüne dönüştürme sürecinde size rehberlik edeceğiz. Aspose.PDF for .NET bu görevi basitleştirerek belge iş akışlarınızı kolayca otomatikleştirmenize ve düzenlemenize olanak tanır.
...
Bu dizin hem kaynak PDF'yi hem de dönüştürülen TIFF dosyalarını saklayacaktır.
...
TIFF görüntüleri için çözünürlüğü ayarlayın. Daha yüksek DPI, daha iyi görüntü kalitesi sağlar:
...
1bpp (piksel başına 1 bit) kullanımı görüntüyü ikili çıktıya hazırlar.
...
Şimdi, gri tonlamalı TIFF görüntüsünü ikili görüntüye dönüştürmek için Bradley Algoritmasını uygulayalım:
...
Son olarak, dönüşümün başarılı olduğunu onaylayın:
